...
| 2026-04-25 | [Locked bootloader](PLAN-locked-bootloader.md) | First real SPICE-channel test as a scene — clipboard paste round-trip dressed as a bootloader-decryption flow; introduces SPICE-client testing infrastructure | Phase 1 complete, Phase 2 in progress | [1. SPICE infra](PLAN-locked-bootloader-phase-01-spice-infra.md), [2. Scene](PLAN-locked-bootloader-phase-02-scene.md), 3. Docs (phase plan pending) |
