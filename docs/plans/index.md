...
| 2026-04-30 | [Display-mode keystrokes](PLAN-display-mode-keystrokes.md) | Interactive GOP mode switching as a first-class test affordance, so a human operator can drive the SPICE client (ryll) through guest mode changes at any tempo | Not started | [1. Renderer](PLAN-display-mode-keystrokes-phase-01-renderer.md), [2. Keystrokes](PLAN-display-mode-keystrokes-phase-02-keystrokes.md), [3. Closeout](PLAN-display-mode-keystrokes-phase-03-docs.md) |
