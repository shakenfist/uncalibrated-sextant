...
| 2026-05-28 | [Continuous multi-channel visual digest](PLAN-continuous-digest.md) | Convert the visual digest from a phase-boundary, server-read-back snapshot into a continuous per-line intent-hash oracle covering every I/O surface — the substitute for the never-built second-serial gRPC channel | Not started | [1. Intent hash](PLAN-continuous-digest-phase-01-intent-hash.md), [2. Cadence](PLAN-continuous-digest-phase-02-cadence.md), [3. Multi-channel](PLAN-continuous-digest-phase-03-multi-channel.md), [4. Closeout](PLAN-continuous-digest-phase-04-closeout.md) |
