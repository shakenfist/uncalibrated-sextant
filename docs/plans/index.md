...
| 2026-05-01 | [Audit cleanup](PLAN-audit-cleanup.md) | Bug fixes, structural dedup, and headless coverage gaps surfaced by the first PUSH-TEMPLATE.md audit run | Not started | [1. Bugs](PLAN-audit-cleanup-phase-01-bugs.md), [2. Structural](PLAN-audit-cleanup-phase-02-structural.md), [3. Tests](PLAN-audit-cleanup-phase-03-tests.md) |
