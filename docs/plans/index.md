...
| 2026-05-01 | [Visual on-screen digest](PLAN-visual-digest.md) | Implement the visual half of DESIGN.md's two-channel test architecture: render a periodic, ring-buffer-driven QR digest into the framebuffer that an external decoder (ryll) can read from a screenshot | Not started | [1. Region](PLAN-visual-digest-phase-01-region.md), [2. Payload](PLAN-visual-digest-phase-02-payload.md), [3. Closeout](PLAN-visual-digest-phase-03-closeout.md) |
